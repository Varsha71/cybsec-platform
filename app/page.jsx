...
const HomePage = () => {
    ...
    return (
        <div className='min-h-screen grid place-items-center'>
            ...
            <a className='fixed bottom-0 flex items-center gap-2 pb-2 font-mono text-sm text-white/70 transition hover:text-emerald-300 sm:m-0' href='https://github.com/Varsha71/cybsec-platform' target='_blank'>
            </a>
        </div>
    )
}
